...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ...
    {...props}
  >
    <DropdownMenuPrimitive.ItemIndicator className="absolute left-2 top-1/2 flex -translate-y-1/2 items-center justify-center">
...
>(({ className, children, ...props }, ref) => (
  <DropdownMenuPrimitive.RadioItem
    ...
    {...props}
  >
    <DropdownMenuPrimitive.ItemIndicator className="absolute left-3 top-1/2 flex -translate-y-1/2 items-center justify-center">
